 ...
 <div className="left-side-form">
     <form className="contactus-form">
         <div id="login-lable">Contact Us</div>
         <input className="contact-form-content" type="text" placeholder="First Name" />
         <input className="contact-form-content" type="text" placeholder="Last Name" />
         <input className="contact-form-content" type="text" placeholder="Email" />
         <textarea className="contact-form-content" placeholder="Your message"></textarea>
         <div className="contactus-buttons">
             <button><a href="/about">Send</a></button>
         </div>
     </form>
 ...
 <div className="right-side-form">
     <img src={require("../../Assets/images/logo.png")} alt="" className="right-image" />
     <div className="right-amount">
         <div className="company-address">
             <h1><i><FontAwesomeIcon icon={faMapMarkerAlt} /></i>Address</h1>
             <p>8500, Lorem Street, Chicago, IL, 55030</p>
         </div>
         <div className="company-phone">
             <h1><i><FontAwesomeIcon icon={faPhone} /></i>Phone</h1>
             <p>(123) 456-78-91</p>
             <p>(123) 456-78-91</p>
         </div>
         <div className="company-email">
             <h1><i><FontAwesomeIcon icon={faEnvelope} /></i>Email</h1>
             <p>eduspecial@edu.com</p>
         </div>
     </div>
 ...
 <div className="map-pic">
     ...
     <div className="map-hover">
         ...
         <div className="map-hover-inner">
             <h5>Riad Al Soloh Stadium</h5>
             <p>Nabatieh City, Lebanon</p>
         </div>
     </div>
 </div>
</div>