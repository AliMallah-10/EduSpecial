    ...
    return (
        <div className="eventspage w-full md:w-11/12 lg:w-11/12 xl:w-11/12 mx-auto bg-white">
            ...
            <div className="background h-96 md:h-80 lg:h-96 xl:h-96 mt-20 mb-20 relative">
                <img src={require("../../Assets/images/creative.jpg")} alt="" className="image object-cover w-full h-full" />
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white z-10">
                    <h1 className="text-5xl md:text-4xl xl:text-5xl font-bold whitespace-nowrap">Creative Skills Development</h1>
                    <h3 className="flex flex-row m-auto mt-10 uppercase">
                        ...
                        <span className="text-yellow-700 text-2xl md:text-xl xl:text-2xl font-bold whitespace-nowrap">Creative Skills Development</span>
                    </h3>
                </div>
            </div>
            ...
            <div className="upcoming-events mt-20 mb-20 mx-auto bg-white flex flex-col items-center">
                <img src={require("../../Assets/images/blog-4.jpg")} alt="Logo" className="w-full md:w-11/12 lg:w-10/12 xl:w-9/12 h-auto mb-5" />
            ...
            <div className="events-buttons flex justify-between mt-10 mx-4">
                {/* Back button */}
                <Link to="/eventsblogtwo" className="back-button py-2 px-8 text-black text-base font-bold rounded-full overflow-hidden bg-yellow-500 transition-all duration-400 ease-in-out shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 uppercase mb-20 flex items-center ml-10">
                    <i className="mr-3"><FontAwesomeIcon icon={faArrowLeft} /></i>
                    <span>Dad’s Day at the School</span>
                </Link>
                {/* Next button */}
                <Link to="/eventsblogfour" className="next-button py-2 px-8 text-black text-base font-bold rounded-full overflow-hidden bg-yellow-500 transition-all duration-400 ease-in-out shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 uppercase mb-20 flex items-center mr-10">
                    <span className="mr-3">Spring Camp in the Forest</span>
...
export default EventsBlogThree;
