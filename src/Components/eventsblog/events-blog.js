...
import { faCalendarPlus, faChevronDown, faChevronUp, faArrowRight } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <div className="eventspage w-full md:w-11/12 lg:w-11/12 xl:w-11/12 mx-auto bg-white">
            ...
            <div className="upcoming-events mt-20 mb-20 mx-auto bg-white flex flex-col items-center">
                <img src={require("../../Assets/images/comingevent2.jpg")} alt="Logo" className="w-full md:w-11/12 lg:w-10/12 xl:w-9/12 h-auto mb-5" />
            ...
            <div className="events-buttons flex justify-between mt-10 mx-4">
                ...
                <Link to="/eventsblogtwo" className="next-button flex items-center py-2 px-8 text-black text-base font-bold rounded-full overflow-hidden bg-yellow-500 transition-all duration-400 ease-in-out shadow-md hover:scale-105 hover:text-white hover:shadow-lg active:scale-90 uppercase mb-20 mr-10">
                    <span className="mr-3">Dad’s Day at the School</span>
